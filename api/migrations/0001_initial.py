        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "contact_type",
                    models.CharField(
                        choices=[("phone", "Телефон"), ("address", "Адрес доставки")],
                        max_length=10,
                        verbose_name="Тип",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=40, unique=True, verbose_name="Название параметра"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "article",
                    models.CharField(
                        max_length=100, verbose_name="Артикул/ID у поставщика"
                    ),
                ),
                (
                    "available_count",
                    models.PositiveIntegerField(verbose_name="Остаток на складе"),
                ),
                (
                    "cost_price",
                    models.DecimalField(
                ...
                (
                    "retail_price",
                    models.DecimalField(
                        decimal_places=2, max_digits=10, verbose_name="Розничная цена"
                    ),
                ),
                (
                    "parameters",
                    models.JSONField(
                        blank=True, default=dict, verbose_name="Параметры товара"
                    ),
                ),
                (
                    "product",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "url",
                    models.URLField(
                        blank=True, null=True, verbose_name="Ссылка на API поставщика"
                    ),
                ),
                (
                    "accepts_orders",
